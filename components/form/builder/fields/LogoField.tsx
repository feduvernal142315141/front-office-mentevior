...
interface LogoFieldProps<TFormValues extends FieldValues = FieldValues> {
  field: FieldConfig<TFormValues>
  error?: string
  onFieldChange?: (name: string, value: any) => void
}

export function LogoField<TFormValues extends FieldValues = FieldValues>({
  field,
  error,
  onFieldChange,
}: LogoFieldProps<TFormValues>) {
