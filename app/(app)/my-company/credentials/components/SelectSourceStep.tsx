...
import type { SourceType } from "../hooks/useCredentialDrawer"
    ...
    <div className="p-6 space-y-6">
      <div>
        <p className="text-gray-600 mt-1">
          Choose how you want to add a credential to your organization
        </p>
      </div>
      ...
      <div className="grid gap-4">
            ...
            <div className="flex flex-col justify-between flex-1 min-w-0">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Select an existing credential and customize it for your organization
                </p>
              </div>
              ...
              <div className="mt-3 space-y-1 text-sm text-gray-700">
                <div className="flex items-center gap-2">
                  ...
                  <span>Official credential data pre-filled</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-blue-600" />
                  <span>Customize taxonomy code and billing codes</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-blue-600" />
                  <span>Lower risk of configuration errors</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <button
          onClick={() => {
            onClose()
            router.push("/my-company/credentials/create?mode=manual")
          }}
          className="
            group relative w-full p-6 text-left
          ...
          <div className="flex gap-4 h-50 lg:h-53 xl:h-38 2xl:h-40">
            ...
            <div className="flex flex-col flex-1 min-w-0">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Create a custom credential not included in the catalog
                </p>
              </div>
              ...
              <div className="mt-6 space-y-1 text-sm text-gray-700">
                <div className="flex items-center gap-2">
                  ...
                  <span>Define name, short name and taxonomy code</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-gray-500" />
                  <span>Optional organization and website</span>
                </div>
                <div className="flex items-center gap-2">
                  <Check className="w-4 h-4 text-gray-500" />
                  <span>Best for custom organizational credentials</span>
                </div>
              </div>
            </div>
          </div>
