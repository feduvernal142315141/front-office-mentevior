...
export function SupervisionConfigSkeleton() {
  return (
      ...
      <div className="mx-auto max-w-5xl xl:max-w-6xl">
        ...
        <Card variant="elevated" padding="lg">
          ...
          <div className="flex flex-col gap-4">
            <div className="h-[52px] rounded-[16px] bg-gray-100 animate-pulse" />
            <div className="h-[96px] rounded-[16px] bg-gray-100 animate-pulse" />
          </div>
        </Card>
