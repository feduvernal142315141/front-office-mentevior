...
import type { SourceType } from "../hooks/useHRDocumentDrawer"
    ...
    <div className="p-6 space-y-6">
      <div>
        <p className="text-gray-600 mt-1">
          Choose how you want to add HR documents to your organization
        </p>
      </div>
      ...
      <div className="grid gap-4">
            ...
            <div className="flex flex-col justify-between flex-1 min-w-0">
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Select standard HR documents from our pre-configured catalog
                </p>
              </div>
        ...
        <button
          onClick={() => {
            onClose()
            router.push("/hr-documents/create?mode=manual")
          }}
          className="
            group relative w-full p-6 text-left
