                ...
                return (
                  <div key={key} className={cn(
                    ...
                    <div className={cn(
                      ...
                      isEditable ? "border border-emerald-400 bg-white shadow-sm" : "border border-slate-200 bg-slate-50/80",
                    )}>
                      ...
                      <input type="text" inputMode="numeric" value={entry.occurrences || ""} disabled={!isEditable}
                        ...
                        className={cn(
                          ...
                          isEditable ? "bg-white border border-emerald-400 text-slate-800 focus:border-[#037ECC] focus:ring-2 focus:ring-[#037ECC]/15" : "bg-slate-50 border border-slate-200 text-slate-400",
                        )}
                        placeholder="0" />
