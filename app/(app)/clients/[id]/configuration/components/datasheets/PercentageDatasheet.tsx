                  ...
                  <div key={key} className={cn(
                    ...
                    <div className={cn("flex items-center gap-1 rounded-xl p-1", isEditable ? "border border-emerald-400 bg-white shadow-sm" : "border border-slate-200 bg-slate-50/80")}>
                      ...
                      <input type="text" inputMode="numeric" value={entry.occurrences || ""} disabled={!isEditable}
                        ...
                        className={cn("h-8 w-12 rounded-lg text-center text-sm font-semibold tabular-nums outline-none transition-all", isEditable ? "bg-white border border-emerald-400 text-slate-800 focus:border-[#037ECC] focus:ring-2 focus:ring-[#037ECC]/15" : "bg-slate-50 border border-slate-200 text-slate-400")}
                        placeholder="0" />
