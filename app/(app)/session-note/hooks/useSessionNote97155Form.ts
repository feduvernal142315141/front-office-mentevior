...
export function useSessionNote97155Form({ appointmentId }: UseSessionNote97155FormProps) {
  ...
  const isLoadingCatalogs = modalityLoading || participantsLoading || catalogsLoading
