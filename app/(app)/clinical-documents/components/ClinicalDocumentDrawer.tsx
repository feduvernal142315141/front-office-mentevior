...
import { useClinicalDocumentDrawer } from "../hooks/useClinicalDocumentDrawer"
import { VisuallyHidden } from "@radix-ui/react-visually-hidden"

interface ClinicalDocumentDrawerProps {
  isOpen: boolean
  onClose: () => void
  onSuccess: () => void
}

export function ClinicalDocumentDrawer({ isOpen, onClose, onSuccess }: ClinicalDocumentDrawerProps) {
  const {
    currentStep,
    reset,
    selectSource,
    goBack,
  } = useClinicalDocumentDrawer()
